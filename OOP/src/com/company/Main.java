...
*/
    ...
    Перегрузите этод метод для компьютеров. Создайте такой же метод, устанавливающий объём памяти для компьютеров.
    Используйте эти методы на практике.*/


        Computers myPC = new Laptops();
        myPC.setPower(300, myPC);
        myPC.setDDRCapacity(4000, myPC);
        myPC.
